...
```
Download `train_FD001.txt` from the [Kaggle dataset link](https://www.kaggle.com/datasets/behrad3d/nasa-cmaps) and place it in a folder named `NASA Dataset` in the same directory as the notebook.
