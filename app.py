...
with tab_fleet:
    ...
    st.caption("Each engine's most recent recorded cycle, scored with the trained Random Forest model.")

    latest = df.sort_values("cycle").groupby("engine_id").tail(1).copy()
